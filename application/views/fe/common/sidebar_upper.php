...
<ul class="features">
    ...
    <li><a href="<?php echo site_url('main/page/'.$value->id); ?>"><?php echo $value->menutitle; ?></a><?php if($value->icon != NULL):?><img src="<?php echo site_url('images/'.$value->icon.'.png');?>" alt="notice" width="20px" height="20px" style="margin-left: 5px;" /><?php endif;?></li> 
    <?php endforeach;?>
