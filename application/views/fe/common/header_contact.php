...
<!-- top section start -->
    ...
    <div class="logo"><a href="<?php echo site_url('main/index');?>"><img src="<?php echo site_url('images/logo.png')?>" alt="Webcon Consulting India Pvt. Ltd." title="Webcon Consulting India Ltd." /></a></div>
